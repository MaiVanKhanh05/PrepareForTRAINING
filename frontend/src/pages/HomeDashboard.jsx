  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 animate-in fade-in slide-in-from-bottom-5 duration-700">
        ...
        {/* AI Assistant - 9/12 */}
        <div onClick={() => navigate('/home/chat')} className="md:col-span-9 bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-800 rounded-3xl p-8 text-white flex flex-col
         md:flex-row items-center justify-between shadow-xl relative overflow-hidden transition-all
